...
public class ContentCodeGenerator {
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/rulin-plus-generator/src/main/java");
		gc.setAuthor("程序儒");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.101.65:3306/zc_" + SERVICE_NAME
